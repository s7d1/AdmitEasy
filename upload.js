...
app.post('/upload', upload.single('pdfFile'), (req, res) => {
    ...
    <script>
        ...
        setInterval(function() {
            ...
            if (count == 0) {
                window.location.href = "C:/Users/TengQ/OneDrive/Documents/GitHub/DeerHacks2023/processed_resume_review.html"; // Replace "/" with the URL of your desired redirect page
            }
        }, 1000);
    </script>
`);});
